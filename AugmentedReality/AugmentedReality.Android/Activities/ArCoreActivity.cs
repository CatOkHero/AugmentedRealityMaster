...
namespace AugmentedReality.Droid.Activities
{
    [Activity(Label = "ArCoreActivity", ParentActivity = typeof(MainActivity))]
    [MetaData("android.support.PARENT_ACTIVITY", Value = ".MainActivity")]
    public class ArCoreActivity : BaseActivity, GLSurfaceView.IRenderer, View.IOnTouchListener
    {
        const string TAG = "HELLO-AR";

        protected override int LayoutResource => Resource.Layout.activity_arcore;
